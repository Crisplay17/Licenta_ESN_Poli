...
public class Event {
    ...
    @ManyToMany(mappedBy = "events")
    private List<ErasmusUser> erasmusParticipants = new ArrayList<>();
    ...
    public List<ErasmusUser> getErasmusParticipants() {
        return erasmusParticipants;
    }

    public void setErasmusParticipants(List<ErasmusUser> erasmusParticipants) {
        this.erasmusParticipants = erasmusParticipants;
    }
